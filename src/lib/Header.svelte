...
>
	<button on:click class="flex items-center mb-4 md:mb-0 text-white/70">
		<TvIcon />
		<div class="text-2xl md:text-xl font-bold ml-2">chill.opensourcerecovery.life</div>
	</button>
	<a
